...
forecast_finalFilt$Basis[forecast_finalFilt$Basis == 'fmsyAR_notransfer'] <- 'fmsyAR'
...
print(ggplot()+
        ...
        geom_hline(yintercept = 1130747,col='blue')+
        geom_hline(yintercept = 1049521,col='yellow')+
