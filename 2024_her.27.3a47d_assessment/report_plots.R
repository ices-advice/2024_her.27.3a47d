...
print(ggplot(dat,aes(x=year,y=age,size=10*abs(std.res),col=std.res>0))+
        geom_point(shape=21)+
...
abline(v=1.130747,col="darkgreen",lwd=2,lty=2)
...
text(1.130747,0,labels=expression(B[trigger]),col="darkgreen",cex=1.3,pos=4)
