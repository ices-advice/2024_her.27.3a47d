---
title: "HAWG2024 - NSAS assessment and forecast"
...
## New M SF - input to the assessment
```{r echo=FALSE} 
knitr::include_graphics(file.path('./report/sf',"sf_M smooth.png"))
```

## New M SF - impact on the assessment
```{r echo=FALSE} 
knitr::include_graphics(file.path('./report/sf',"sf_explo_stock_trajectory_SMS2019-2023.png"))
```
...
## MF - fleet proportions

```{r echo=FALSE} 
knitr::include_graphics(file.path('./report/mf',"mf_fleet.prop.png"))
```
...
## Reference points - S-R HAWG2024 vs IBP2021

```{r echo=FALSE} 
knitr::include_graphics(file.path('./report/sf', "sf_SR_comp.png")) 
```

```{r echo=FALSE} 
knitr::include_graphics(file.path('./report/sf', "sf_SR_comp_recent.png")) 
```

```{r echo=FALSE} 
knitr::include_graphics(file.path('./refpoints/plots', "refpointsBlim_NSAS_HAWG2024_sf.png")) 
```

```{r echo=FALSE} 
knitr::include_graphics(file.path('./refpoints/plots', "refpointsBlim_NSAS_HAWG2024_sf_HAWG2023.png")) 
```

## Reference points - HAWG2024

```{r echo=FALSE} 
pander::pandoc.table(read.csv(file.path('refpoints','output','refpoints_summary.csv')),
                     style="simple", split.tables=200, justify="right", missing=".")
```

## Reference points - retrospective

```{r echo=FALSE} 
pander::pandoc.table(read.csv(file.path('refpoints','output','NSAS_HAWG2024_sf_retro.csv')),
                     style="simple", split.tables=200, justify="right", missing=".")
```
...
## Forecast - why a decrease in catch advice?
